...
class Vehicle {
  ...
  String aboutVehicle; // New field for vehicle description
  ...
  Vehicle({
    ...
    required this.aboutVehicle, // Initialize the new field
  });
  ...
  factory Vehicle.fromMap(Map<String, dynamic> map, String id) {
    ...
    return Vehicle(
      ...
      aboutVehicle: map['aboutVehicle'] ?? '', // Extract new field
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'aboutVehicle': aboutVehicle, // Add new field to map
    };
  }
}
